...
type ArtworkModelFilter = {
  ...
  mutiple?: InputMaybe<BooleanFilter>;
...
enum ArtworkModelOrderBy {
  ...
  mutiple_ASC = 'mutiple_ASC',
  mutiple_DESC = 'mutiple_DESC',
  title_ASC = 'title_ASC',
...
type ArtworkRecord = RecordInterface & {
  ...
  mutiple?: Maybe<Scalars['BooleanType']>;
